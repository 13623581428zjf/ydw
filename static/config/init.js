...
;(function() {
  var resList = {
    ...
    js: [
      ...
      //直播插件
      window.SITE_CONFIG.cdnUrl + '/static/plugins/live/report.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/live/live-init.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/live/live-trtc.js',
      // 业务
